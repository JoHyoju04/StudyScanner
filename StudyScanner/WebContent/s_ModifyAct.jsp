...
<script>
function modif(){
	var s_passwd=document.getElementById("s_passwd").value;
	var s_cafeName=document.getElementById("s_cafeName").value;
	var s_address=document.getElementById("s_address").value;
	var url="sModify2.jsp?s_passwd="+s_passwd+"&s_cafeName="+s_cafeName+"&s_address="+s_address;
    window.location.replace(url,"get");
   ...
   <div class="menu">
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input
               type="text" name="s_passwd" id="s_passwd" class="noborder" ></td>
         </tr>
      </table>
      <br>
      <hr>
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input type="text"
               name="s_name" id="s_cafeName" class="noborder" ></td>
         </tr>
      </table>
      <br>
      <hr>
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input
               type="text" id="s_address" name="s_address" class="noborder" ></td>
         </tr>
      </table>
         <%
    }
%>
   ...
   <p align="center">
      <button type="button" class="btn"
         onclick="location.href='s_Choice.jsp' ">취소</button>
      &emsp;
      <button onclick="modif()" class="btn"  >수정완료</button>
   </p>
