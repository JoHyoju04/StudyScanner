...
function modi(){
	...
	var url="cModify2.jsp?c_passwd="+c_passwd+"&c_name="+c_name+"&c_phone="+c_phone;
   ...
   <div class="menu">
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input
               type="text" name="c_passwd" id="c_passwd" class="noborder" ></td>
         </tr>
      </table>
      <br>
      <hr>
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input type="text"
               name="c_name" id="c_name" class="noborder" ></td>
         </tr>
      </table>
      <br>
      <hr>
      ...
      <table align="center">
         <tr>
            ...
            <td width="250" height="40" class="boundary"><input
               type="text" id="c_phone" name="c_phone" class="noborder" ></td>
         </tr>
      </table>
         <%
    }
%>
   ...
   <p align="center">
      <button type="button" class="btn"
         onclick="location.href='c_Search.jsp' ">취소</button>
      &emsp;
      <button onclick="modi()" class="btn"  >수정완료</button>
   </p>
